    ...
    <div>
      <div className="max-w-7xl mx-auto">
        <div>
          ...
          <p className="my-4 text-black text-2xl">
            ...
            is a JavaScript library for building user interfaces. React ships
            with several ways to minimize the number of costly DOM operations
            required to update the UI. For many applications, using React will
            lead to a fast user interface without doing much work to
            specifically optimize for performance. Nevertheless, there are
            several ways you can speed up your React application. Let’s dive in
            and learn some of these techniques.
          </p>
          ...
          <p className="my-4 text-black text-2xl">
            When working with React, there are cases where you will need to
            render multiple elements or return a group of related items. Here’s
            an example:
          </p>
          <Code
        ...
        return (
          ...
          <p className="my-4 text-black text-2xl">
            ...
            enclosing tag. This implies that you need to wrap both elements
            within a parent div.
          </p>
          <Code
            code={`function App() {
        return (
          ...
          />
          <p className="my-4 text-black text-2xl">
            Doing this will fix the error, but it comes with a degree of risk.
            You are adding an extra node to the DOM, which is not necessary. In
            a case like this, where the above is a child component that will be
            enclosed within a parent component, this becomes a problem.
          </p>
          <Code
            code={`function Table() {
        return (
      ...
      function Columns() {
        return (
          ...
          />
          <p className="my-4 text-black text-2xl">
            The resulting HTML for the Table component will be invalid because
            of the additional div that was added.
          </p>
          <Code
            code={`function Table() {
        return (
          ...
          <p className="my-4 text-black text-2xl">
            ...
            , which will not add any additional node to the DOM. The syntax
            looks like this:
          </p>
          <Code
        ...
        return (
          ...
          <p className="my-4 text-black text-2xl">
            ...
            This can be very useful while you’re developing, but it can make
            your app size large and responses slower than usual. If your project
            is built with create-react-app, you can fix this by running npm run
            build before deploying, which will create a production-ready build
            of your app in a build/ folder that you can then deploy. You can
            confirm if your app is in either development or production mode
            using the{" "}
            <Link
              target="_blank"
        ...
        <div>
          ...
          <p className="my-4 text-black text-2xl">
            ...
            since each state update will re-render all relevant components. It
            can also act as a medium to communicate between various components.
          ...
          <p className="my-4 text-black text-2xl">
            ...
            different states. It covers essential aspects of an application such
            as loading spinners, error messages, pop-ups, and many others which
            showcases that a communication link has been formed. Communication
            state is the “loading phase” of the transactions between different
            states. It stores the following information when used in a React
            app:
            <br />
            <br />
            <ul>
          ...
          />
          <p className="my-4 text-black text-2xl">
            For example, you can see where your transaction is moving:
            retrieving, updating, sending, receiving, failed, etc. without
            having to set any command to determine the true or false value for a
            request.
            <br />
            <br />
            Communication state is accessible from anywhere using Connect. It
            can be independently stored and managed by Redux.
          </p>
          ...
          <p className="my-4 text-black text-2xl">
            ...
            <br />
            <br />
            The Data state will receive all the information from the outer
            ...
            specifies the kind of data received. You can design a redux store
            for your data once you have mapped out a way to identify the type
            and id of a received object.
            <br />
            <br />
            After mapping the type of data and storing relevant information, you
            can easily access the datastore from anywhere via Connect. Since
            each state of a React app follows a particular set of rules, you can
            play around with your information as long as it aligns with the
            pre-defined rules.
            <br />
            <br />
          ...
          <p className="my-4 text-black text-2xl">
            ...
            objects in place, selected items act as a single string of
            information representing an Id, and the control state efficiently
            stores both kinds of data without any trouble.
            <br />
            <br />
            However, it follows a rule which only allows components specific to
            a single screen, or a container to be stored. If you have a state
            which has a predictable shape like the data or communication and it
            needs to be readily available throughout the application at any
            point in time, use Redux. For other states, like the Control state
            which doesn’t follow a specific pattern of shape and is not required
            to be present throughout, you can use setState instead of Redux.
          </p>
          <h3 className="my-4 text-black text-3xl font-semibold text-blue-600">
            4. Session State
          </h3>
          <p className="my-4 text-black text-2xl">
            ...
            <ul>
              <li>
                1. Data/ Communication State- Predictable shaped states which
                are required application-wide
              </li>
              <br />
              <li>
            ...
            <br />
            <br />
            Now let’s discuss a state which is required to be available
            throughout the application but has a lesser well-defined shape.
            <br />
            <br />
        ...
        <div>
          ...
          <p className="my-4 text-black text-2xl">
            ...
            to a constructor function. And objects inherit properties and
            methods from a prototype. For example,
          </p>
          <Code
        ...
        <div>
          ...
          <p className="my-4 text-black text-2xl">
            ...
            <ul>
              ...
              <br />
              <li>
                7. In the testing pyramid, unit tests are faster than
